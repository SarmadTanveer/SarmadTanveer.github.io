...
return {
  ...
  getInput: function(){
      return{
        type : document.querySelector(DOMstrings.inputType).value,  //Will be either inc or expfun
...
//Event Listener
  ...
  var ctrlAddItem = function(){
    ...
    // 2.add item to the budget budgetController
  ...
  var ctrlDeleteItem = function(event){
    ...
    //Delete selected item from Budget
    budgetCtrl.deleteItem(type, parseInt(ID));
    //Delete item from UI
    UICtrl.deleteListItem(itemID);
    //Update and show the new Budget
    updateBudget();
    //Calculate and update update Percentages
    updatePercentages();}
